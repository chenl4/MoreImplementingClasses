...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.v_rect = rg.Rectangle(rg.Point(intersection_center.x - (1 / 2) * letter_thickness,
                                            intersection_center.y - (1 / 2) * letter_thickness),
                                   rg.Point(intersection_center.x + (1 / 2) * letter_thickness,
                                            intersection_center.y + height - (1 / 2) * letter_thickness))
